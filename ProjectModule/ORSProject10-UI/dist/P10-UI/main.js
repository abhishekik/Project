...
/* harmony import */ var _contact_contactlist_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./contact/contactlist.component */ "./src/app/contact/contactlist.component.ts");
...
var routes = [
    ...
    {
        path: 'contact',
        component: _contact_contact_component__WEBPACK_IMPORTED_MODULE_35__["ContactComponent"]
    },
    {
        path: 'contact/:id',
        component: _contact_contact_component__WEBPACK_IMPORTED_MODULE_35__["ContactComponent"]
    ...
    {
        path: 'contactlist',
        component: _contact_contactlist_component__WEBPACK_IMPORTED_MODULE_36__["ContactlistComponent"]
    },
    {
        path: 'myprofile',
...
/* harmony import */ var _prescription_prescription_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./prescription/prescription.component */ "./src/app/prescription/prescription.component.ts");
/* harmony import */ var _prescription_prescription_list_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./prescription/prescription-list.component */ "./src/app/prescription/prescription-list.component.ts");
/* harmony import */ var _contact_contact_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./contact/contact.component */ "./src/app/contact/contact.component.ts");
/* harmony import */ var _contact_contactlist_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./contact/contactlist.component */ "./src/app/contact/contactlist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _prescription_prescription_component__WEBPACK_IMPORTED_MODULE_47__["PrescriptionComponent"],
                _prescription_prescription_list_component__WEBPACK_IMPORTED_MODULE_48__["PrescriptionListComponent"],
                _contact_contact_component__WEBPACK_IMPORTED_MODULE_49__["ContactComponent"],
                _contact_contactlist_component__WEBPACK_IMPORTED_MODULE_50__["ContactlistComponent"]
            ],
            imports: [
...
var ContactComponent = /** @class */ (function (_super) {
    ...
    function ContactComponent(locator, route, httpClient) {
        var _this = _super.call(this, locator.endpoints.CONTACT, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
    ...
    ContactComponent.prototype.parseDate = function (dateString) {
        if (dateString) {
    ...
    ContactComponent.prototype.onUpload = function (userform) {
        this.submit();
    };
    ContactComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
        form.dob = data.dob;
    ...
    ContactComponent.prototype.validateAlphabetInput = function (event) {
        var str = event.key;
        console.log(str);
    ...
    ContactComponent.prototype.validateMobileInput = function (event) {
        var values = event.target.value + event.key;
...
/***/ "./src/app/contact/contactlist.component.css":
/*!***************************************************!*\
  !*** ./src/app/contact/contactlist.component.css ***!
  \***************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbnRhY3QvY29udGFjdGxpc3QuY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/contact/contactlist.component.html":
/*!****************************************************!*\
  !*** ./src/app/contact/contactlist.component.html ***!
  \****************************************************/
/*! no static exports found */
...
var ContactlistComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ContactlistComponent, _super);
    function ContactlistComponent(locator, route, httpClient) {
        var _this = _super.call(this, locator.endpoints.CONTACT, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        _this.httpClient = httpClient;
    ...
    ContactlistComponent.prototype.validateMobileInput = function (event) {
        var values = event.target.value + event.key;
        if (!/^[6-9][0-9]{0,9}$/.test(values)) {
            event.preventDefault();
        }
    };
    ContactlistComponent.prototype.validateAlphabetInput = function (event) {
        console.log(event);
        var str = event.key;
        console.log(str);
        if (!/^[a-zA-Z\s]*$/.test(str)) {
    ...
    ContactlistComponent.prototype.submit = function () {
        this.form.pageNo = 0;
        this.search();
    };
    ...
    ContactlistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./contactlist.component.html */ "./src/app/contact/contactlist.component.html"),
            styles: [__webpack_require__(/*! ./contactlist.component.css */ "./src/app/contact/contactlist.component.css")]
        }),
...
var EndpointServiceService = /** @class */ (function () {
    function EndpointServiceService() {
        ...
        this.CONTACT = this.SERVER_URL + "/Contact";
    }
...
var PrescriptionListComponent = /** @class */ (function (_super) {
    ...
    PrescriptionListComponent.prototype.ngOnInit = function () {
        _super.prototype.ngOnInit.call(this);
    };
    PrescriptionListComponent.prototype.submit = function () {
        this.form.pageNo = 0;
        this.search();
    };
    PrescriptionListComponent.prototype.search = function () {
        this.form.searchMessage = null;
        _super.prototype.search.call(this);
    };
    PrescriptionListComponent.prototype.validateNumericInput = function (event) {
        var str = event.key;
        console.log(str);
        if (!/^\d$/.test(str)) {
            event.preventDefault();
...
module.exports = "<app-navbar></app-navbar>\r\n<style>\r\n  .grad{\r\n background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\r\n background-repeat: no repeat;\r\n background-size: 100%;\r\n padding-bottom: 25px\r\n ;\r\n }\r\n</style>\r\n\r\n<div class=\"row \" style=\"padding-top: 3%; padding-bottom:3%;\r\nbackground: url(assets/files/wall.jpg) no-repeat center center;\r\nbackground-attachment: fixed;\r\nbackground-size: cover;width:auto;\r\n  height: auto;\">\r\n\r\n  <div class=\"col-sm-4\"></div>\r\n  <div class=\"col-sm-4\">\r\n    <div class=\"card\">\r\n      <div class=\"card-body shadow-lg grad\">\r\n        <form>\r\n          <h2 *ngIf=\"!form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Add prescription' | translate }}</h2>\r\n          <h2 *ngIf=\"form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Update prescription' | translate }}</h2>\r\n\r\n          <div *ngIf=\"form.error && form.message != null\" class=\"alert alert-danger alert-dismissible\">\r\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n            {{form.message}}\r\n          </div>\r\n          <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\r\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n            {{form.message}}\r\n          </div>\r\n\r\n          <div style=\"padding-top:3%\">\r\n            <span class=\"pt-2\"><b>{{'Name' | translate }}</b>\r\n              <span class=\"required-field\"></span></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-user grey-text\"></i> </div>\r\n                </div>\r\n                <input type=\"text\" name=\"name\" [(ngModel)]=\"form.data.name\" class=\"form-control\"\r\n                  placeholder=\"{{'Enter Name' | translate }}\">\r\n              </div>\r\n            </div><span class=\"alertRedColor\"> {{form.inputerror.name}} </span>\r\n          </div>\r\n\r\n          <div style=\"padding-top:3%\">\r\n            <span class=\"pt-2\"><b>{{'Decease' | translate }}</b>\r\n              <span class=\"required-field\"></span></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-map-marker grey-text\"></i> </div>\r\n                </div>\r\n                <input type=\"text\" name=\"decease\" [(ngModel)]=\"form.data.decease\" class=\"form-control\"\r\n                  placeholder=\"{{'Enter Decease' | translate }}\">\r\n              </div>\r\n              <span class=\"alertRedColor\"> {{form.inputerror.decease}} </span>\r\n            </div>\r\n          </div>\r\n\r\n          <div style=\"padding-top:3%\">\r\n            <span class=\"pt-2\"><b>{{'Date' | translate }}</b>\r\n              <span class=\"required-field\"></span></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-location-arrow grey-text\"></i> </div>\r\n                </div>\r\n                <input type=\"date\" name=\"date\" [(ngModel)]=\"form.data.date\" class=\"form-control\"\r\n                  placeholder=\"{{'Enter Date' | translate }}\">\r\n              </div>\r\n              <span class=\"alertRedColor\"> {{form.inputerror.date}} </span>\r\n            </div>\r\n          </div>\r\n\r\n          <div style=\"padding-top:3%\">\r\n            <span class=\"pt-2\"><b>{{'Capacity' | translate }}</b>\r\n              <span class=\"required-field\"></span></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-address-card grey-text\"></i> </div>\r\n                </div>\r\n                <input type=\"text\" name=\"capacity\" [(ngModel)]=\"form.data.capacity\" class=\"form-control\"\r\n                  placeholder=\"{{'Enter Capacity' | translate }}\">\r\n              </div>\r\n              <span class=\"alertRedColor\"> {{form.inputerror.capacity}} </span>\r\n            </div>\r\n          </div>\r\n\r\n          \r\n          <div class=\"row pt-3 pl-3 pb-3\">\r\n            <div class=\"pt-2\">\r\n              <button *ngIf=\"!form.data.id>0\" (click)=\"submit()\" [disabled]=\"!validate()\" class=\"btn btn-success mr-2\">\r\n                {{'Save' | translate }}</button>\r\n            </div>\r\n            <div class=\"pt-2\">\r\n              <button *ngIf=\"form.data.id>0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                {{'Update' | translate }}</button>\r\n            </div>\r\n\r\n            <div class=\"pl-3 pt-2\">\r\n              <button (click)=\"forward('/prescriptionlist')\" type=\"button\"\r\n                class=\"btn btn-warning mr-1\">{{'List' | translate }}\r\n              </button>\r\n            </div>\r\n          </div>\r\n        </form>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n<app-footer></app-footer>"
...
module.exports = __webpack_require__(/*! E:\ProjectModule\ORSProject10-UI\src\main.ts */"./src/main.ts");
